...
public class ChooseSeatActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(timeBooked == null || timeBooked.isEmpty()) {
            timeBooked = Timestamp.now().toString();
        }
        dateBooked = intent.getStringExtra("dateBooked");
        if(dateBooked == null || dateBooked.isEmpty()) {
            dateBooked = Timestamp.now().toString();
        }
        ...
        if(cinema == null) {
            cinema = new Cinema("1" , "1"  , "1" , "1" ,1 , "1" , "1");
        }
        ...
        SeatBookBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(selectedIds.size() == 0){
                    Toast.makeText(ChooseSeatActivity.this, "Please choose seats!", Toast.LENGTH_SHORT).show();
                }
                else{
