...
public class AddServiceActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.add_service_screen);
        ...
        LinearLayoutCompat layoutElement = findViewById(R.id.LinerLayout);
    ...
    private void uploadImageToStorage() {
        ...
        storageReference.putFile(ImageUri).addOnSuccessListener(taskSnapshot -> {
            storageReference.getDownloadUrl().addOnSuccessListener(uri -> {
                ...
                Toast.makeText(AddServiceActivity.this, "Upload + Download Image Successfully", Toast.LENGTH_SHORT).show();
            }).addOnFailureListener(exception -> {
                Toast.makeText(AddServiceActivity.this, "Download Image Failed", Toast.LENGTH_SHORT).show();
            });
        }).addOnFailureListener(exception -> {
            Toast.makeText(AddServiceActivity.this, "Upload Image Failed", Toast.LENGTH_SHORT).show();
        });
    }
