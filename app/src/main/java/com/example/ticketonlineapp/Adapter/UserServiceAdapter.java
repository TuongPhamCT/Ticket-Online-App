...
public class UserServiceAdapter extends ArrayAdapter<Service> {
    private List<Service> listService;
    private TextView totalService;
    private List<ServiceInTicket> listServiceInTicket;
    private int total;
    public UserServiceAdapter(@NonNull Context context, int resource, List<Service> listService, TextView totalService, List<ServiceInTicket> listServiceInTicket) {
