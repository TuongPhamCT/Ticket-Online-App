...
public class CinemaNameAdapter extends ArrayAdapter<Cinema> {
    ...
    public CinemaNameAdapter(@NonNull Context context, int resource, List<Cinema> listCinema, Film film) {
                ...
                if(Users.currentUser!=null)
                    if(((Users.currentUser.getAccountType().toString()).equals("admin")))
                    {
                        if(ScheduledFilm.getInstance().isDateSelected && ScheduledFilm.getInstance().isCitySelected){
                            ...
                            FirebaseRequests.database.collection("Showtime").addSnapshotListener(new EventListener<QuerySnapshot>() {
                                @Override
